...
Version  : 5.7
Release  : 2
URL      : https://github.com/Beep6581/RawTherapee/archive/5.7/RawTherapee-5.7.tar.gz
Source0  : https://github.com/Beep6581/RawTherapee/archive/5.7/RawTherapee-5.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571000568
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/RawTherapee-5.7/LICENSE.txt %{buildroot}/usr/share/package-licenses/RawTherapee/104279e4adcd0129581bde3e8f7411a11447f687
cp %{_builddir}/RawTherapee-5.7/licenses/osx_libiomp5_LICENSE.txt %{buildroot}/usr/share/package-licenses/RawTherapee/7199ab66e2eba41e76504929b9d8d52e7a44413f
cp %{_builddir}/RawTherapee-5.7/rtdata/languages/LICENSE %{buildroot}/usr/share/package-licenses/RawTherapee/d6c3778e0861da294b04b13d20a00ae17abb6b56
pushd clr-build
%make_install
popd
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/RawTherapee/104279e4adcd0129581bde3e8f7411a11447f687
