...
Source0  : https://github.com/Beep6581/RawTherapee/archive/5.9/RawTherapee-5.9.tar.gz
...
%prep
%setup -q -n RawTherapee-5.9
cd %{_builddir}/RawTherapee-5.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686941248
mkdir -p clr-build
pushd clr-build
